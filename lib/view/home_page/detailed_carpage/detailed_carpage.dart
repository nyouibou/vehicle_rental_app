...
class DetailedCarpage extends StatefulWidget {
  ...
  @override
  State<DetailedCarpage> createState() => _DetailedCarpageState();
}

class _DetailedCarpageState extends State<DetailedCarpage> {
  @override
