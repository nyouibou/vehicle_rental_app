...
class SedanDetailedCarpage extends StatefulWidget {
  const SedanDetailedCarpage({
    super.key,
    required this.image,
    required this.model,
    required this.make,
  ...
  @override
  State<SedanDetailedCarpage> createState() => _DetailedCarpageState();
}

class _DetailedCarpageState extends State<SedanDetailedCarpage> {
  @override
