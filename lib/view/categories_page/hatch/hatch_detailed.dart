...
class HatchDetailedCarpage extends StatefulWidget {
  const HatchDetailedCarpage({
    super.key,
    required this.image,
    required this.model,
    required this.make,
  ...
  @override
  State<HatchDetailedCarpage> createState() => _DetailedCarpageState();
}

class _DetailedCarpageState extends State<HatchDetailedCarpage> {
  @override
